...
import styles from './vizu_sugs_ADM.module.css'
      ...
      <main>
        <section className={styles.blocos_filmes}>
          <div className={styles.seta_voltar}>
            <button className={styles.bac-button}>&#8592;</button>
          </div>
            ...
            <div className={styles.parte3}>
              ...
              <div className={styles.adc_remov_button}>
                        <a href="add_sugs_ator_ADM.html">
                            <div className={styles.adicionar}><button className={styles.adc_button}>Adicionar</button></div>
                        </a>
